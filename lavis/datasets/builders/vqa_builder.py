...
from lavis.datasets.datasets.coco_vqa_cycle_datasets import COCOVQACYCLEDataset
...
@registry.register_builder("coco_vqa_cycle")
class COCOVQACYCLEBuilder(BaseDatasetBuilder):
    train_dataset_cls = COCOVQACYCLEDataset
    eval_dataset_cls = COCOVQAEvalDataset

    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/coco/defaults_vqa_cycle.yaml",
        "eval": "configs/datasets/coco/eval_vqa.yaml",
    }
